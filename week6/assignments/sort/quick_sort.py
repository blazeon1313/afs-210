...
def quick_sort2(a_list, start, end):
    ...
    quick_sort2(a_list, start, pivot-1)
    quick_sort2(a_list, pivot+1, end)
...
def quick_sort3(a_list, start, end):
    ...
    quick_sort3(a_list, start, pivot-1)
    quick_sort3(a_list, pivot+1, end)
...
def quick_sort4(a_list, start, end):
    ...
    quick_sort4(a_list, start, pivot-1)
    quick_sort4(a_list, pivot+1, end)
...
start_time = time.time()
quick_sort3(myList,0,len(myList)-1)
end_time = time.time()

print(f"The execution time is: {end_time-start_time}")

print("Quick Sort End Pivot:")
myList = [x for x in range(1000)]
random.shuffle(myList)

start_time = time.time()
quick_sort4(myList,0,len(myList)-1)
end_time = time.time()
